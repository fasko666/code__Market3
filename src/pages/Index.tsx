...
${formData.message}
  ...
  return (
    <div className="relative z-10">
      ...
      {/* Hero Section */}
      <section id="home" ref={heroRef} className="min-h-screen flex items-center justify-center relative overflow-hidden px-[5%] pt-20 perspective-1000">
        {/* 3D Animated Background Shapes */}
        <div className="floating-shape w-20 h-20 top-[20%] left-[10%] animate-float3D" style={{ animationDelay: '0s' }} />
        <div className="floating-shape w-16 h-16 top-[60%] right-[15%] animate-pulse3D" style={{ animationDelay: '2s' }} />
        <div className="floating-shape w-24 h-24 bottom-[20%] left-[20%] animate-morph" style={{ animationDelay: '4s' }} />
        <div className="floating-shape w-12 h-12 top-[40%] right-[25%] animate-spin3D" style={{ animationDelay: '1s', animationDuration: '15s' }} />
        <div className="floating-shape w-14 h-14 bottom-[40%] right-[10%] animate-float3D" style={{ animationDelay: '3s' }} />
        
        {/* 3D Orbiting Elements */}
        <div className="absolute w-[300px] h-[300px] top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 pointer-events-none">
          <div className="absolute w-4 h-4 rounded-full bg-primary/50 animate-orbit" style={{ animationDuration: '10s' }} />
          <div className="absolute w-3 h-3 rounded-full bg-accent/50 animate-orbit" style={{ animationDuration: '15s', animationDirection: 'reverse' }} />
          <div className="absolute w-2 h-2 rounded-full bg-primary/30 animate-orbit" style={{ animationDuration: '20s' }} />
        </div>
        
        <div className="max-w-[1400px] mx-auto text-center relative z-10">
          {/* Logo Animation with 3D effect */}
          <div className="mb-8 animate-fadeInUp perspective-1000">
            <div className="relative inline-block preserve-3d animate-pulse3D">
              <img 
                src={logo} 
                alt="CodeMarket" 
              ...
              <div className="absolute inset-[-10px] rounded-full border border-accent/10 animate-ping" style={{ animationDuration: '3s', animationDelay: '0.5s' }} />
            </div>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center animate-fadeInUp" style={{ animationDelay: '0.4s' }}>
            <a href="#contact" className="cta-button flex items-center justify-center gap-2 group hover:scale-105 transition-transform">
              {t('about_btn')} 
              <ArrowRight size={20} className="group-hover:translate-x-1 transition-transform" />
            </a>
            <Link to="/services" className="auth-btn flex items-center justify-center gap-2 group hover:scale-105 transition-transform">
              {t('nav_services')} 
              <ArrowRight size={20} className="group-hover:translate-x-1 transition-transform" />
            </Link>
          </div>
          ...
          <div className="absolute bottom-10 left-1/2 -translate-x-1/2 animate-bounce">
            <div className="w-6 h-10 rounded-full border-2 border-muted-foreground/50 flex items-start justify-center p-2 relative">
            ...
            <div className="space-y-6">
              ...
              <div className="p-6 glass-card rounded-xl text-center hover:scale-[1.02] transition-all hover:shadow-lg hover:shadow-primary/10">
                ...
                <div className="flex gap-4 justify-center">
                  <a 
                    href="https://www.facebook.com/codemarket.studio" 
                    target="_blank" 
                    rel="noopener noreferrer" 
                    className="social-link-enhanced group"
                    aria-label="Facebook"
                  >
                    <Facebook size={20} className="relative z-10 transition-transform group-hover:scale-110" />
                  </a>
                  <a 
                  ...
                  >
                    <Instagram size={20} className="relative z-10 transition-transform group-hover:scale-110 group-hover:rotate-12" />
                  </a>
                  <a 
                    href="https://www.linkedin.com/company/codemarket-studio" 
                    target="_blank" 
                    rel="noopener noreferrer" 
                    className="social-link-enhanced group"
                    aria-label="LinkedIn"
                  >
                    <Linkedin size={20} className="relative z-10 transition-transform group-hover:scale-110" />
                  </a>
                </div>
              </div>
            </div>
            ...
            {formSuccess ? (
              ...
              <form onSubmit={handleContactSubmit} className="glass-card rounded-2xl p-8 space-y-6">
                ...
                <button 
                  ...
                  className="cta-button w-full flex items-center justify-center gap-2 h-14 text-lg group"
                >
                  {formSubmitting ? (
                    ...
                    <>
                      <Send size={20} /> 
                      {t('form_submit')}
                      <Instagram size={18} className="ml-1 opacity-70" />
                    </>
                  )}
                </button>
