        ...
        <div>
          ...
          <div className="flex gap-3">
            <a 
              ...
              aria-label="Facebook"
            >
              <Facebook size={18} className="relative z-10 transition-transform group-hover:scale-110" />
            </a>
            <a 
            ...
            >
              <Instagram size={18} className="relative z-10 transition-transform group-hover:scale-110 group-hover:rotate-12" />
            </a>
            <a 
              ...
              aria-label="LinkedIn"
            >
              <Linkedin size={18} className="relative z-10 transition-transform group-hover:scale-110" />
            </a>
          </div>
        </div>
